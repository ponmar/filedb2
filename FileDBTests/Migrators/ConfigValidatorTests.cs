...
public class ConfigMigratorTests
{
    ...
    public void Migrate()
    {
        var configWithDefaultValues = new Config(default, default, default, default, default, default, default, default, default, default, default, default, default, default, default, default, default, default, default, default, default, default);
