...
{
    public class FileDBHandle : IFileDBHandle
    {
        public FileDBConfig Config { get; }

        private static readonly ILog log = LogManager.GetLogger("FileDBHandle");

        public FileDBHandle(FileDBConfig config, bool allowMissingFilesRootDirectory = true)
        {
            ...
            {
                throw new FileDBException($"Database does not exist: {config.Database}");
            }
            ...
            if (!Directory.Exists(config.FilesRootDirectory))
            {
                ...
                {
                    throw new FileDBException(message);
                }
            }
        ...
        {
            using var connection = FileDBUtils.CreateConnection(Config.Database);
        ...
        public void InsertFile(string internalPath, string description = null)
        {
            ...
            if (!File.Exists(path))
            {
                throw new FileDBDataValidationException($"No such file: {path}");
            }
        ...
        public void ValidateFileDescription(string description)
        {
            ...
            {
                throw new FileDBDataValidationException("Empty file description should be null");
            }
        }
        ...
        public void ValidatePersonFirstname(string firstname)
        {
            ...
            {
                throw new FileDBDataValidationException("Person firstname empty");
            }
        }
        ...
        public void ValidatePersonLastname(string lastname)
        {
            ...
            {
                throw new FileDBDataValidationException("Person lastname empty");
            }
        }
        ...
        public void ValidatePersonDescription(string description)
        {
            if (description == string.Empty)
            {
                throw new FileDBDataValidationException("Empty person description should be null");
            }
        }
        ...
        public void ValidatePersonDateOfBirth(string dateOfBirthStr)
        {
            ...
            {
                throw new FileDBDataValidationException("Invalid format for person date of birth (should be YYYY-MM-DD)");
            }
        }
        ...
        public void ValidatePersonProfileFileId(int? profileFileId)
        {
            ...
            {
                throw new FileDBDataValidationException($"File with id {profileFileId.Value} does not exist");
            }
        }
        ...
        public void ValidateTagName(string name)
        {
            ...
            {
                throw new FileDBDataValidationException("Tag name empty");
            }
        }
        ...
        public void ValidateLocationName(string name)
        {
            if (string.IsNullOrEmpty(name))
            {
                throw new FileDBDataValidationException("Location name empty");
            }
        }
        ...
        public void ValidateLocationDescription(string description)
        {
            if (description == string.Empty)
            {
                throw new FileDBDataValidationException("Empty location description should be null");
            }
        }
        ...
        public void ValidateLocationGeoLocation(string geoLocationStr, out GeoLocation geoLocation)
        {
            if (geoLocationStr != null)
            {
                ...
                if (parts.Length != 2)
                {
                    throw new FileDBDataValidationException("Location geo-position invalid format (two parts should be specified)");
                }

                if (!double.TryParse(parts[0], out double latitude))
                {
                    throw new FileDBDataValidationException("Location geo-position has invalid latitude");
                }

                if (!double.TryParse(parts[0], out double longitude))
                {
                    throw new FileDBDataValidationException("Location geo-position has invalid longitude");
                }
